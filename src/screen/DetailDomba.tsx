      ...
      <ScrollView showsVerticalScrollIndicator={true}>
        <View style={styles.pageup}>
          <Image
            ...
            source={require('../assets/image/Kambing-Jawa-Randu-1024x768.jpeg.png')}
          />

          <Text style={styles.textsapi}>paket domba/kambing</Text>
          <Text style={styles.textkind}>
            JENIS KAMBING/DOMBA YANG KAMI SEDIAKAN :
          </Text>
          <View style={styles.border}></View>
          <Text style={styles.textkind2}>
            Kami menyediakan beberapa jenis kambing/domba kebutuhan qurban untuk
            Anda.
          </Text>
        </View>
        {/* {;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;} */}
        <View style={styles.paketreguler}>
          ...
          <View style={styles.divtextreguler}>
            ...
            <Text style={styles.textprice}>Rp 3.750.000</Text>
            <Text style={styles.textintro}>
              Bobot -/+ 45 Kg dengan jenis kambing/ domba menyesuaikan.
            </Text>
            <TouchableOpacity
              onPress={() => navigation.navigate('deliveryform')}>
              {/* <Text style={styles.textpesan1}>PESAN</Text> */}
            </TouchableOpacity>
        ...
        <View style={styles.paketmedium}>
          <TouchableOpacity>
            <Image
              ...
              source={require('../assets/image/Domba-Jawa-1024x768.jpeg.png')}
            />
          </TouchableOpacity>

          <View style={styles.divtextmedium}>
            <Text style={styles.textpaket2}>PAKET MEDIUM</Text>
            <Text style={styles.textprice2}>Rp 4.500.000</Text>
            <Text style={styles.textintro2}>
              Bobot -/+ 50 Kg dengan jenis kambing/ domba menyesuaikan.
            </Text>
            <TouchableOpacity
              onPress={() => navigation.navigate('deliveryform')}>
              {/* <Text style={styles.textpesan2}>PESAN</Text> */}
            </TouchableOpacity>
        ...
        <View style={styles.paketpremium}>
          <TouchableOpacity>
            <Image
              ...
              source={require('../assets/image/Domba-Gembel-1024x766.jpeg.png')}
            />
          </TouchableOpacity>
          <View style={styles.divtextpremium}>
            <Text style={styles.textpaket3}>PAKET PREMIUM</Text>
            <Text style={styles.textprice3}>Rp 5.500.000</Text>
            <Text style={styles.textintro3}>
              Bobot -/+ 55 Kg dengan jenis kambing/ domba menyesuaikan.
            </Text>
            <TouchableOpacity
              onPress={() => navigation.navigate('deliveryform')}>
