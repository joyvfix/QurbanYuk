...
const App = () => {
  const tabs = [
    {title: 'produk', content: <Text style={{fontSize: 10}}>produk</Text>},
    {
      title: 'delivery',
      content: <Text style={{fontSize: 10}}>pemesanan</Text>,
    },
    {
      title: 'pembayaran',
      content: <Text style={{fontSize: 10}}>pembayaran</Text>,
    },
    {title: 'user', content: <Text style={{fontSize: 10}}>user</Text>},
  ];
